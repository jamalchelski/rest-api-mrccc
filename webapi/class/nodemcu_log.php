...
class Nodemcu_log
{
    ...
    {
        $sqlQuery = "SELECT id, id_station, suhu, kelembaban, created_at FROM " . $this->db_table . "";
    ...
    public function createLogData()
    {
        ...
        // bind data
        $stmt->bindParam(":id_station", $this->id_station);
    ...
    public function getSingleLogData()
    {
        ...
        if ($stmt->errorCode() == 0) {
            while (($dataRow = $stmt->fetch(PDO::FETCH_ASSOC)) != false) {
                $this->id_station = $dataRow['id_station'];
    ...
    public function updateDataLog()
    {
        ...
        $this->id_station = htmlspecialchars(strip_tags($this->id_station));
        $this->suhu = htmlspecialchars(strip_tags($this->suhu));
        $this->kelembaban = htmlspecialchars(strip_tags($this->kelembaban));
